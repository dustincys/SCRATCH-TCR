...
for sample in contigs_list:

  adata_tmp = ir.io.read_10x_vdj(os.path.join(sample, "outs", "filtered_contig_annotations.csv"))
...
df, dst, lk = ir.tl.repertoire_overlap(
    adata_tcr, "sample", target_col = "cc_aa_identity", inplace = False
)
...
adata_tcr.write_h5ad(output_object)
